...
public class Predicate extends PredicateAbstract{
	...
	public void addGroundValueLine(String... values) throws ParseException{
		if(values.length!=this.getTypes().size()){
			throw new ParseException("Predicate: " + this.getName() + " - The size of the line input has to be equal to the size of the types attribute. Add types first.");
		}
