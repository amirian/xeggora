...
public class FormulaCardinality extends FormulaHard {
	...
	public FormulaCardinality(String name, HashSet<VariableType> forVariables, ArrayList<IfExpression> ifExpressions,
			HashSet<VariableType> overVariables, ArrayList<PredicateExpression> restrictions, int cardinality, boolean lessEqual) throws ParseException {
