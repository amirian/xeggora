...
*/
		...
		long size = 0;
//Me 			
		if (Parameters.DEBUG_OUTPUT) System.out.println("Hidden Predicates("+model.getAllHiddenPredicates().size()+")->");
...
//Me 			
		if (Parameters.DEBUG_OUTPUT) System.out.println("Observed Predicates("+model.getAllObservedPredicates().size()+")->");
