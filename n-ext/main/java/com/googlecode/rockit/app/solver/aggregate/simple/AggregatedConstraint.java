...
public class AggregatedConstraint {
	...
	public AggregatedConstraint(String id, ArrayList<Literal> aggregatedVars, boolean conjunction, boolean isHard, double weight){
		this.id=id;
	...
	public void addConstraintAndDeleteOldOne(ILPConnector con) throws ILPException{
		con.addAggregatedConstraint(isHard, weight, aggregatedVars, singleVars, conjunction);
	}
