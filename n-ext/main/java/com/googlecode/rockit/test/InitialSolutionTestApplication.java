...
public class InitialSolutionTestApplication
{
    ...
    public static void main(String[] args) throws IOException, ParseException, RecognitionException, SolveException, SQLException, ReadOrWriteToFileException
    {
        ...
        Main.main(new String[] { "-data", folder + "evidence.db", "-input", folder + "prog.mln", "-output", "output.db", "-para", "xeggora.properties" });
        time1 = System.currentTimeMillis() - time1;
        time2 = System.currentTimeMillis();
        Main.main(new String[] { "-data", folder + "evidence.db", "-input", folder + "prog.mln", "-output", "output.db", "-para", "xeggora.properties", "-isolution", folder + "initialSolution.db" });
