...
public class FullAggregationManager implements AggregationManager{
	...
	private ArrayList<PredicateExpression> aggregatedExpressions;
	private ArrayList<PredicateExpression> aggregatingExpressions;
	private boolean isConjunction;
	private boolean isHard;
	
	public FullAggregationManager(ArrayList<PredicateExpression> aggregatedExpressions, ArrayList<PredicateExpression> aggregatingExpressions,
	...
	public ArrayList<PredicateExpression> getAggregatedExpressions() {
		return aggregatedExpressions;
	}
	
	public ArrayList<PredicateExpression> getAggregatingExpressions() {
...
//Me Temp
//		if (aggregatingExpressions.size()>2)
//			System.out.println("'" + id + "' ADDED: " + aggregatingAxiomsForClause);
	}
