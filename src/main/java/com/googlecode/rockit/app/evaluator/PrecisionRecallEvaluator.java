...
public class PrecisionRecallEvaluator {
	 ...
	 * Calls evaluate. 
	 * 
	 * @param results the results from the solver
	 * @param goldStandards list of gold standard axioms
	 */
	 ...
	 * used as gold standard.
	 * 
	 * @param specificPredicateNames If you want to evaluate it only for a specific predicate, just plug in the name of the predicate here.
	 * @param results
	 * @param model
	 */
	 ...
	 * used as gold standard.
	 * 
	 * @param specificPredicateName If you want to evaluate it only for a specific predicate, just plug in the name of the predicate here.
	 * @param results
	 * @param model
	 */
