...
public class Parameters {
	...
	public static String PROPERTYFILE = "xeggora.properties";
...
//Me{
	/**
	 * Aggregation order, can be in {1, 2} default is 2
	 * 1 means simple cutting plane aggregation presented by Jan Noessner. set it 2 for the new quadratic aggregation method. 
	 * It is used in cutting plane aggregation method, so, disabling cutting plane aggregation makes the engine ignore this parameter 
	 */
	public static int AGGREGATION_ORDER = -1;
//}Me	
	/**
	 ...
	 */
	public static double TIME_LIMIT = 3000;//-1;
	 ...
	 * 
	 */
	public static boolean SIMPLIFY_NEGATIVE_WEIGHT_AND_CONJUNCTION = false;//true;//Me changed to false
	 ...
	 */
	public static String SQL_PASSWORD = "phdmaster";//Me"mannheim1234";
	/**
	 * Database configurations: database name
	 */
	public static String SQL_DATABASE = "xeggora";
	/**
	...
	public static void readPropertyFile() throws ReadOrWriteToFileException {
        ...
        try {
			...
			throw new ReadOrWriteToFileException("Please define your properties data in a xeggora.properties file");
		}
...
//Me{
        Parameters.AGGREGATION_ORDER = Integer.parseInt(properties.getProperty("aggregation_order"));
//}Me
